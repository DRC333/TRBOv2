Contributing to TRBO
============================

The TRBO project operates an open contributor model where anyone is
...
The following applies to code changes to the TRBO project, and is not to be
confused with overall TRBO Network Protocol consensus changes.

Whether a pull request is merged into TRBO rests with the project merge
...
The project leader is the release manager for each TRBO release.
