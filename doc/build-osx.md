...
* Database errors have been seen in builds on High Sierra. One solution is to build Berkeley DB from source.
        ...
        Then configure TRBO with this build of BerkeleyDB,
...
The use homebrew to install a number of unix programs and libraries needed to build the TRBO wallet:
...
You have the choice to build the GUI TRBO wallet as a Mac OSX app, described in “How to build the TRBO-Qt App”. If, for whatever reason, you prefer to use the command line tools, continue with “Command line tools”.

### How to build the TRBO-Qt App:

After make is finished, you can create an App bundle inside a disk image with:

```make deploy```

Once this is done, you’ll find TRBO-Qt.dmg inside your TRBO folder. Open and install the wallet like any typical Mac app.
