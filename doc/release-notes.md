TRBO version 3.0.4 is now available from:

  <https://github.com/trboproject/trbo/releases>
...
Please report bugs using the issue tracker at github:
  ...
  <https://github.com/trboproject/trbo/issues>


Mandatory Update
==============

TRBO v3.0.4 is a mandatory update for all users. This release contains various updates/fixes pertaining to the zTRBO protocol, supply tracking, block transmission and relaying, as well as usability and quality-of-life updates to the GUI.
...
TRBO is extensively tested on multiple operating systems using
...
TRBO should also work on most other Unix-like systems but is not
...
- #327 `aa1235a` [Main] Don't limit zTRBO spends from getting into the mempool (Fuzzbawls)
...
### GUI
- #309 `f560ffc` [UI] Better error message when too much inputs are used for spending zTRBO (Mrs-X)
...
- #314 `f1c830a` Fix issue causing crash when trbod --help was invoked (Jon Spock)
- #326 `8b6a13e` Combine 2 LogPrintf statement to reduce debug.log clutter (Jon Spock)
- #328 `a6c18c8` [Main] TRBO not responding on user quitting app (Aaron Langford)
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/trbo-project-translations/).
