...
* WebSocket: [https://github.com/trboproject/insight-api-trbo#web-socket-api](https://github.com/trboproject/insight-api-trbo#web-socket-api) 
* API: [https://github.com/trboproject/insight-api-trbo#swifttx-transactions](https://github.com/trboproject/insight-api-trbo#swifttx-transactions) 
...
By default, the TRBO daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the TRBO daemon:
