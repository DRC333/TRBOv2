...
VERSION=
commit=false
url=https://github.com/trboproject/trbo
proc=2
mem=2000
lxc=true
...
-u|--url	Specify the URL of the repository. Default is https://github.com/trboproject/trbo
...
then
	...
	then
	    ...
	    ./bin/gsign --signer $SIGNER --release ${VERSION}-aarch64 --destination ../gitian.sigs/ ../trbo/contrib/gitian-descriptors/gitian-aarch64.yml
	    mv build/out/trbo-*.tar.gz build/out/src/trbo-*.tar.gz ../trbo-binaries/${VERSION}
	fi
	popd || exit
