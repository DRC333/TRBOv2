...
enum WalletFeature {
    ...
    FEATURE_WALLETCRYPT = 9533, // wallet encryption
...
enum AvailableCoinsType {
    ALL_COINS = 1,
    ONLY_DENOMINATED = 2,
    ONLY_NOT5000000IFMN = 3,
    ONLY_NONDENOMINATED_NOT5000000IFMN = 4, // ONLY_NONDENOMINATED and not 5000000 TRBO at the same time
    ONLY_5000000 = 5,                        // find masternode outputs including locked ones (use with caution)
