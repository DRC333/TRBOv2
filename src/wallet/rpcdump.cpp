...
UniValue dumpallprivatekeys(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "\nSCAM WARNING: If anyone asks you to run this command and send them the file,\n"
            "they will have FULL ACCESS to STEAL your TRBO. Giving this file to someone\n"
            "is the same thing as giving them all of the TRBO in your wallet! Never send\n"
            "this file to ANYONE that you do not trust with all of your TRBO!!!\n"
           "\nArguments:\n"
            "1. \"filename\"    (string, required) The filename\n"
            "\nExamples:\n" +
