...
UniValue getblock(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 1 || params.size() > 2)
        throw runtime_error(
            ...
            "  \"zTRBOsupply\" :\n"
            "  {\n"
            "     \"1\" : n,            (numeric) supply of 1 zTRBO denomination\n"
            "     \"5\" : n,            (numeric) supply of 5 zTRBO denomination\n"
            "     \"10\" : n,           (numeric) supply of 10 zTRBO denomination\n"
            "     \"50\" : n,           (numeric) supply of 50 zTRBO denomination\n"
            "     \"100\" : n,          (numeric) supply of 100 zTRBO denomination\n"
            "     \"500\" : n,          (numeric) supply of 500 zTRBO denomination\n"
            "     \"1000\" : n,         (numeric) supply of 1000 zTRBO denomination\n"
            "     \"5000\" : n,         (numeric) supply of 5000 zTRBO denomination\n"
            "     \"total\" : n,        (numeric) The total supply of all zTRBO denominations\n"
            "  }\n"
            "}\n"
            "\nResult (for verbose=false):\n"
