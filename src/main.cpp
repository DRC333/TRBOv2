...
int64_t GetBlockValue(int nHeight)
{
    ...
    if (nHeight <= Params().LAST_POW_BLOCK()) {	nSubsidy = 9226000 * COIN;
    } else if (nHeight > 200 && nHeight <= 20000)  {  nSubsidy = 100 * COIN;
    } else if (nHeight > 20001 && nHeight <= 100000)  { nSubsidy = 4000 * COIN;
    } else if (nHeight > 100001 && nHeight <= 200000) { nSubsidy = 4500 * COIN;
    } else if (nHeight > 200001 && nHeight <= 300000) { nSubsidy = 5000 * COIN;
    } else if (nHeight > 300001 && nHeight <= 400000) { nSubsidy = 5500 * COIN;
    } else if (nHeight > 400001 && nHeight <= 500000) { nSubsidy = 5000 * COIN;
    } else if (nHeight > 500001 && nHeight <= 600000) { nSubsidy = 4500 * COIN;
    } else if (nHeight > 600001 && nHeight <= 700000) { nSubsidy = 4000 * COIN;
    } else if (nHeight > 700001 && nHeight <= 800000) { nSubsidy = 3500 * COIN;
    } else if (nHeight > 800001 && nHeight <= 900000) { nSubsidy = 3000 * COIN;
    } else if (nHeight > 900001 && nHeight <= 1000000) { nSubsidy = 2500 * COIN;
    } else if (nHeight > 1000001 && nHeight <= 1100000) { nSubsidy = 2000 * COIN;
    } else if (nHeight > 1100001 && nHeight <= 1250000) { nSubsidy = 2500 * COIN;
    } else if (nHeight > 1250001 && nHeight <= 1400000) { nSubsidy = 3000 * COIN;
    } else if (nHeight > 1400001 && nHeight <= 1550000) { nSubsidy = 3500 * COIN;
    } else if (nHeight > 1550001 && nHeight <= 1700000) { nSubsidy = 4000 * COIN;
    } else if (nHeight > 1700001 && nHeight <= 1900000) { nSubsidy = 3500 * COIN;
    } else if (nHeight > 1900001 && nHeight <= 2100000) { nSubsidy = 3000 * COIN;
    } else if (nHeight > 2100001 && nHeight <= 2300000) { nSubsidy = 2000 * COIN;
    } else if (nHeight > 2300001 && nHeight <= 2500000) { nSubsidy = 1000 * COIN;
	} else if (nHeight > 2500001 && nHeight <= 2700000) { nSubsidy = 165 * COIN;
	} else if (nHeight > 2700001) { nSubsidy = 0.01 * COIN;
...
bool RecalculateTRBOSupply(int nHeightStart)
{
...
bool static ProcessMessage(CNode* pfrom, string strCommand, CDataStream& vRecv, int64_t nTimeReceived)
{
    ...
    if (strCommand == NetMsgType::VERSION) {
        ...
        if (pfrom->cleanSubVer == "/TRBO Core:1.0.0/") {
            LOCK(cs_main);
        ...
        // TRBO: We use certain sporks during IBD, so check to see if they are
