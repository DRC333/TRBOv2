...
void OverviewPage::getPercentage(CAmount nUnlockedBalance, QString& sTRBOPercentage)
{
    int nPrecision = 2;
    ...
    sTRBOPercentage = "(" + QLocale(QLocale::system()).toString(dPercentage, 'f', nPrecision) + " %)";
                              ...
                              const CAmount& watchOnlyBalance, const CAmount& watchUnconfBalance, const CAmount& watchImmatureBalance)
{
    ...
    // Percentage labels
    ui->labelTRBOPercent->setText(sPercentage);
    ...
    bool showTRBOAvailable = settingShowAllBalances || phrAvailableBalance != nTotalBalance;
    bool showWatchOnlyTRBOAvailable = watchOnlyBalance != nTotalWatchBalance;
    bool showTRBOPending = settingShowAllBalances || unconfirmedBalance != 0;
    bool showWatchOnlyTRBOPending = watchUnconfBalance != 0;
    bool showTRBOLocked = settingShowAllBalances || nLockedBalance != 0;
    bool showWatchOnlyTRBOLocked = nWatchOnlyLockedBalance != 0;
    bool showImmature = settingShowAllBalances || immatureBalance != 0;
    bool showWatchOnlyImmature = watchImmatureBalance != 0;
    bool showWatchOnly = nTotalWatchBalance != 0;
    ui->labelBalance->setVisible(showTRBOAvailable || showWatchOnlyTRBOAvailable);
    ui->labelBalanceText->setVisible(showTRBOAvailable || showWatchOnlyTRBOAvailable);
    ui->labelWatchAvailable->setVisible(showTRBOAvailable && showWatchOnly);
    ui->labelUnconfirmed->setVisible(showTRBOPending || showWatchOnlyTRBOPending);
    ui->labelPendingText->setVisible(showTRBOPending || showWatchOnlyTRBOPending);
    ui->labelWatchPending->setVisible(showTRBOPending && showWatchOnly);
    ui->labelLockedBalance->setVisible(showTRBOLocked || showWatchOnlyTRBOLocked);
    ui->labelLockedBalanceText->setVisible(showTRBOLocked || showWatchOnlyTRBOLocked);
    ui->labelWatchLocked->setVisible(showTRBOLocked && showWatchOnly);
