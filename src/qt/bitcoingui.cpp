...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About TRBO"), this);
    aboutAction->setStatusTip(tr("Show information about TRBO"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the TRBO help message to get a list with possible TRBO command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("TRBO client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("TRBO"); // default title
